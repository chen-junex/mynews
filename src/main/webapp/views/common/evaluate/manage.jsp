...
<div id="main">
	<div id="toolbar">
		<a class="waves-effect btn btn-info btn-sm" href="javascript:addAction();" ><i class="zmdi zmdi-plus"></i> 新增评论</a>
		<a class="waves-effect btn btn-warning btn-sm" href="javascript:editAction();" ><i class="zmdi zmdi-edit"></i> 编辑评论</a>
		<a class="waves-effect btn btn-danger btn-sm" href="javascript:deleteAction();" ><i class="zmdi zmdi-delete"></i> 删除评论</a>
	...
	<div class="container col-md-11" style="margin-top: 10px; margin-left: 55px; display: table;">
		<div class="row" style="margin-top: 10px; margin-bottom: 10px;">
			<div class="col-md-4 text-left"
				...
				<label style="margin-top: 5px; font-size: 14px; color: grey;">评论id：</label>
			</div>
			<div class="col-md-7">
				<div class="form-group">
					<input type="text" id="news_id" name="news_id" class="form-control" placeholder="评论名（必填）" />
				</div>
			</div>
		</div>
		<div class="row" style="margin-top: 10px; margin-bottom: 10px;">
		...
		<div class="row" style="margin-top: 10px; margin-bottom: 10px;">
			<div class="col-md-4 text-left"
				style="background-color: #D2E9FF; line-height: 26px; vertical-align: middle;">
				<label style="margin-top: 5px; font-size: 14px; color: grey;">评论标题：</label>
			</div>
			<div class="col-md-7">
				<div class="form-group">
...
$(function() {
	...
	$table.bsTable({
		url: '${pageContext.request.contextPath}/common/evaluate/list',
		idField: 'evaluate_id',// 指定主键列
		singleSelect: true,
		search: true,
		columns: [
			{field: 'state', checkbox: true},
			{field: 'evaluate_id', title: 'id', align: 'center'},
			{field: 'evaluate_context', title: '评论内容', align: 'center'},
			{field: 'evaluate_datetime', title: '评论时间', align: 'center'},
			{field: 'user_id', title: '评论人id', align: 'center'},
			{field: 'user_name', title: '评论人', align: 'center'},
			{field: 'news_id', title: '新闻id', align: 'center'},
			{field: 'user_photo', title: '图片', align: 'center'},
			{field: 'is_show', title: '是否显示', align: 'center'},
            {field: 'is_delete', title: '是否删除', align: 'center'},
            {field: 'like_number', title: '点击量', align: 'center'},
