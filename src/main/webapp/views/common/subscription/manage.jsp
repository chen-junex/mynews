...
<div id="main">
	<div id="toolbar">
		<a class="waves-effect btn btn-info btn-sm" href="javascript:addAction();" ><i class="zmdi zmdi-plus"></i> 新增订阅</a>
		<a class="waves-effect btn btn-warning btn-sm" href="javascript:editAction();" ><i class="zmdi zmdi-edit"></i> 编辑订阅</a>
		<a class="waves-effect btn btn-danger btn-sm" href="javascript:deleteAction();" ><i class="zmdi zmdi-delete"></i> 删除订阅</a>
	...
	<div class="container col-md-11" style="margin-top: 10px; margin-left: 55px; display: table;">
		<div class="row" style="margin-top: 10px; margin-bottom: 10px;">
			<div class="col-md-4 text-left"
				...
				<label style="margin-top: 5px; font-size: 14px; color: grey;">订阅id：</label>
			</div>
			<div class="col-md-7">
				<div class="form-group">
					<input type="text" id="news_id" name="news_id" class="form-control" placeholder="订阅名（必填）" />
				</div>
			</div>
		</div>
		<div class="row" style="margin-top: 10px; margin-bottom: 10px;">
		...
		<div class="row" style="margin-top: 10px; margin-bottom: 10px;">
			<div class="col-md-4 text-left"
				 style="background-color: #D2E9FF; line-height: 26px; vertical-align: middle;">
				<label style="margin-top: 5px; font-size: 14px; color: grey;">订阅标题：</label>
			</div>
			<div class="col-md-7">
				<div class="form-group">
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $table.bsTable({
            url: '${pageContext.request.contextPath}/common/subscription/list',
            idField: 'sub_id',// 指定主键列
            singleSelect: true,
            search: true,
            columns: [
                {field: 'state', checkbox: true},
                {field: 'sub_id', title: 'id', align: 'center'},
                {field: 'sub_name', title: '订阅名称', align: 'center'},
                {field: 'sub_datetime', title: '订阅时间', align: 'center'},
                {field: 'sub_type', title: '订阅类型', align: 'center'},
                {field: 'sub_photo', title: '图片', align: 'center'},
